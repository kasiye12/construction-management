...
<body>
    ...
    <div class="letterhead">
        ...
        <div class="company-info">
            <div>📞 +251-000-000000</div>
            <div>📧 info@tntconstruction.com</div>
            <div>📍 Addis Ababa, Ethiopia</div>
            <div>TIN: 000000000</div>
        </div>
    </div>
    ...
    <div class="info-grid">
        ...
        <div class="info-item"><span class="label">Retention:</span><span class="value">{{ $ipc->retention_percentage ?? 5 }}%</span></div>
    </div>
    ...
    <div class="signatures">
        <div class="sig-box">
            @if($ipc->prepared_by)<div class="sig-name">{{ $ipc->prepared_by }}</div>@endif
            <div class="sig-line">Prepared By</div>
            @if($ipc->prepared_at)<div class="sig-date">{{ \Carbon\Carbon::parse($ipc->prepared_at)->format('M d, Y') }}</div>@endif
        </div>
        <div class="sig-box">
            @if($ipc->checked_by)<div class="sig-name">{{ $ipc->checked_by }}</div>@endif
            <div class="sig-line">Checked By</div>
            @if($ipc->checked_at)<div class="sig-date">{{ \Carbon\Carbon::parse($ipc->checked_at)->format('M d, Y') }}</div>@endif
        </div>
        <div class="sig-box">
            @if($ipc->approved_by)<div class="sig-name">{{ $ipc->approved_by }}</div>@endif
            <div class="sig-line">Approved By</div>
            @if($ipc->approved_at)<div class="sig-date">{{ \Carbon\Carbon::parse($ipc->approved_at)->format('M d, Y') }}</div>@endif
        </div>
    </div>
