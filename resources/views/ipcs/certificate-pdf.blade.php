...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .print-btn-hidden { position: fixed; top: 10px; right: 10px; background: #1a237e; color: white; border: none; padding: 8px 16px; border-radius: 5px; cursor: pointer; font-size: 12px; font-weight: 600; z-index: 1000; }
        @media print { .print-btn-hidden { display: none !important; } }
    </style>
</head>
<body>
    <button class="print-btn-hidden" style="display:none;">🖨️ Print (A4)</button>

    @php
        $logoUrl = \App\Helpers\PdfHelper::getLogoBase64();
