...
<head>
    ...
    <style>
        ...
        .error-message { font-size: 16px; color: #666; margin-bottom: 25px; line-height: 1.5; }
        .btn-back {
        ...
        .btn-back:hover { background: #3730a3; color: white; transform: translateY(-2px); box-shadow: 0 5px 20px rgba(79,70,229,0.4); }
    </style>
</head>
<body>
