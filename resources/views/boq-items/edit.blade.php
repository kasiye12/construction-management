...
@push('styles')
<style>
    .resource-section { background: #f9fafb; border-radius: 8px; padding: 15px; margin-bottom: 15px; }
    .resource-row { background: white; border-radius: 6px; padding: 12px; margin-bottom: 8px; border: 1px solid #e5e7eb; }
</style>
@endpush
        ...
        <div class="col-md-8">
                    ...
                    <div class="row">
                        <div class="col-md-2 mb-3">
                            ...
                            <select name="unit" class="form-select" required>
                                ...
                                <option value="roll" {{ $boqItem->unit=='roll'?'selected':'' }}>Roll</option>
                            </select>
                        </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body" id="laborContainer">
                    ...
                    <div class="resource-row labor-row">
                        <div class="row">
                            ...
                            <div class="col-md-2 mb-2 d-flex align-items-end">
                                <button type="button" class="btn btn-sm btn-danger" onclick="this.closest('.labor-row').remove()"><i class="fas fa-times"></i></button>
                            </div>
                        </div>
                    </div>
                    @php $lIndex++; @endphp
                ...
                <div class="card-body" id="materialContainer">
                    ...
                    <div class="resource-row material-row">
                        <div class="row">
                            ...
                            <div class="col-md-2 mb-2">
                                <label class="form-label small">Unit Rate</label>
                            ...
                            <div class="col-md-2 mb-2 d-flex align-items-end">
                                <button type="button" class="btn btn-sm btn-danger" onclick="this.closest('.material-row').remove()"><i class="fas fa-times"></i></button>
                            </div>
                        </div>
                    </div>
                    @php $mIndex++; @endphp
                    @empty
                    <p class="text-muted" id="noMaterial">No material resources.</p>
                    @endforelse
                </div>
            </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body" id="equipmentContainer">
                    ...
                    <div class="resource-row equipment-row">
                        <div class="row">
                            ...
                            <div class="col-md-2 mb-2">
                                <label class="form-label small">Rate/Hour</label>
                            ...
                            <div class="col-md-2 mb-2 d-flex align-items-end">
                                <button type="button" class="btn btn-sm btn-danger" onclick="this.closest('.equipment-row').remove()"><i class="fas fa-times"></i></button>
                            </div>
                        </div>
                    </div>
                    @php $eIndex++; @endphp
                    @empty
                    <p class="text-muted" id="noEquipment">No equipment resources.</p>
                    @endforelse
                </div>
            </div>
...
function addLaborRow() {
    const html = `<div class="resource-row labor-row"><div class="row">
        ...
        <div class="col-md-2 mb-2 d-flex align-items-end"><button type="button" class="btn btn-sm btn-danger" onclick="this.closest('.labor-row').remove()"><i class="fas fa-times"></i></button></div>
    </div></div>`;
...
function addMaterialRow() {
    const units = ['kg','ton','m3','m2','m','liter','pcs','bag','roll','cylinder','box','sheet','pack','set','pair','lot'];
    let unitOptions = '<option value="">Select</option>';
    units.forEach(u => unitOptions += `<option value="${u}">${u}</option>`);
    
    const html = `<div class="resource-row material-row"><div class="row">
        ...
        <div class="col-md-2 mb-2"><select name="materials[${materialCount}][unit]" class="form-select form-select-sm">${unitOptions}</select></div>
        ...
        <div class="col-md-2 mb-2 d-flex align-items-end"><button type="button" class="btn btn-sm btn-danger" onclick="this.closest('.material-row').remove()"><i class="fas fa-times"></i></button></div>
    </div></div>`;
...
function addEquipmentRow() {
    const html = `<div class="resource-row equipment-row"><div class="row">
        ...
        <div class="col-md-2 mb-2 d-flex align-items-end"><button type="button" class="btn btn-sm btn-danger" onclick="this.closest('.equipment-row').remove()"><i class="fas fa-times"></i></button></div>
    </div></div>`;
